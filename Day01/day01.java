public class day01 {    
    public static void main(String[] args) {
        String input = "hcpjssql4kjhbcqzkvr2fivebpllzqbkhg\n" + //
        ...
        System.out.println("Total Sum: " + calculateSum(input));
    }
...
//                 "2gzqrfldtlpeight3fivencmlmffivevqkhncfm\n" + //
//                 "7bbfbcvh6\n" + //
//                 "ffnrprtnine1tjznmckv5sixczv"; // Replace with actual input
//         System.out.println("Total Sum: " + calculateSum(input));
//     }

//     private static int calculateSum(String input) {
//         Map<String, String> numberWords = createNumberWordMap();
...
//             if (!firstDigit.isEmpty() && !lastDigit.isEmpty()) {
//                 firstDigit = numberWords.getOrDefault(firstDigit, firstDigit);
//                 lastDigit = numberWords.getOrDefault(lastDigit, lastDigit);
...
//     private static Map<String, String> createNumberWordMap() {
